...
int sensor_ix019_954_init(sensor_info_t *sensor_info)
{
	int ret = RET_OK;
	int setting_size = 0;
	...
	/*======954init======*/
	setting_size = sizeof(ds954_ix019_init_setting)/sizeof(uint32_t)/2;
	...
	ret = vin_write_array(deserial_if->bus_num, deserial_if->deserial_addr, 1, setting_size, ds954_ix019_init_setting);
	if (ret < 0) {
...
int sensor_init(sensor_info_t *sensor_info)
{
	...
	/*======954init======*/
	ret = sensor_ix019_954_init(sensor_info);
	if (ret < 0) {
		vin_err("sensor_ix019_954_init fail\n");
		return ret;
	}
	/*======933init======*/
	setting_size = sizeof(ds933_ix019_init_setting)/sizeof(uint32_t)/4;
