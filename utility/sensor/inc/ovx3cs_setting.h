...
* All rights reserved.
***************************************************************************/
#ifndef UTILITY_SENSOR_INC_OVX3CS_SETTING_H_
#define UTILITY_SENSOR_INC_OVX3CS_SETTING_H_
...
uint32_t ovx3c_init_setting_rst[] = {
	// X3C_1920x1280_30fps_HDR4_PWL12_mipi400.txt
	// stream off
	0x0100, 0x00,
	0x0103, 0x01,
	0x0107, 0x01,
...
uint32_t ovx3c_trigger_arbitrary_mode_setting[] = {
	...
	0x3822, 0x04,  // enable mode fix timing counter, numb of rows before frame end
...
#endif  // UTILITY_SENSOR_INC_OVX3CS_SETTING_H_
